...
/**
* This Describe function for adding and deleting podcast
...
describe('AddinganddeletingpodcastPage',function(){
    /**
   ...
   */
    it('Test podcast Page Scroll Down',() => {
        onPrepare: async () => {
   ...
   */
    ...
    it('Test podcast Page Scroll Up',() => {
   ...
   */
    ...
    /**
   *this it function Test open library then podcast test
   */
    it('open library then podcast test  ',  function () {
    ...
    /**
   *this it function Test adding podcast
   */


    it('add podcast ',  function () {


        protractor_1.browser.get('https://open.spotify.com/collection/podcasts') 
        protractor_1.browser.sleep(2000)   
        ...
        protractor_1.element(protractor_1.by.className('_2f8ed265fb69fb70c0c9afef329ae0b6-scss')).sendKeys('Freedom willam')
        expect(protractor_1.browser.getCurrentUrl()).toBe("https://open.spotify.com/podcast/3Aw8a13WJi24hkjRRtMp9n")
   ...
   */
    ...
    it('follow podcast ',  function () {


        protractor_1.browser.get('https://open.spotify.com/podcast/5abSRg0xN1NV3gLbuvX24M') 
        protractor_1.browser.sleep(2000)   
 ...
 /**
   *this it function verify podcast  added
   */


    it('verify podcast is added ',  function () {
    ...
    /**
   *this it function Test odelete podcast
   */

    it('Delete podcast',  function () {
   ...
   */
    ...
    it('Verify podcast is deleted',  function () {
