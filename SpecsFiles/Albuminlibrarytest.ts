...
/**
* This Describe function for adding and deleting album
...
describe('AddinganddeletingalbumPage',function(){
    /**
   ...
   */
    it('Test album Page Scroll Down',() => {
        onPrepare: async () => {
   ...
   */
    ...
    /**
   *this it function Test open library then album test
   */
    it('open library then album test  ',  function () {
    ...
    /**
   *this it function Test adding album
   */


    it('add album ',  function () {


        protractor_1.browser.get('https://open.spotify.com/collection/albums') 
        protractor_1.browser.sleep(2000)   
        ...
        expect(protractor_1.browser.getCurrentUrl()).toBe("https://open.spotify.com/album/3Aw8a13WJi24hkjRRtMp9n")
   ...
   */
    ...
    it('follow album ',  function () {


        protractor_1.browser.get('https://open.spotify.com/album/5abSRg0xN1NV3gLbuvX24M') 
        protractor_1.browser.sleep(2000)   
 ...
 /**
   *this it function verify album  added
   */


    it('verify album is added ',  function () {
    ...
    /**
   *this it function Test odelete album
   */

    it('Delete album',  function () {
   ...
   */
    ...
    it('Verify album is deleted',  function () {
